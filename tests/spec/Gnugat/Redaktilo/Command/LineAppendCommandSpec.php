...
class LineAppendCommandSpec extends ObjectBehavior
{
    const ORIGINAL_FILENAME = '%s/tests/fixtures/sources/composer.json';
    const EXPECTED_FILENAME = '%s/tests/fixtures/expectations/composer.json';
